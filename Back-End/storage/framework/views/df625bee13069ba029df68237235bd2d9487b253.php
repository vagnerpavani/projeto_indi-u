...
<?php else: ?>
<?php echo app('translator')->getFromJson('Att'); ?>,<br><?php echo e(config('app.name')); ?>
...
<?php echo app('translator')->getFromJson(
    "Em caso de dúvidas, sugestões ou reclamações entrar em contato conosco através desse email."
